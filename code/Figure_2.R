...
metaresult_group<- readxl::read_xlsx('F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/Source Data.xlsx',sheet = "Figure2")
...
p1 <- ggplot(data = mydata,
             aes(x=Management,y=mean,shape=Group,fill=Group)) +
...
p2 <- ggplot(data = mydata,
      ...
      geom_text(aes(x = Management, y = ci.ub + 1, label = n),
...
ggsave(plot = p, file = "F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/picture/Figure 2.png",width = 410,height = 270, units = "mm")
