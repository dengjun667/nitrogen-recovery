...
##################################### ROM (metafor) ####################################################
# read data
d1 <- readxl::read_xlsx('F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/Source Data.xlsx',sheet = "Tables")
d1 <- as.data.table(d1)
...
malit <- readxl::read_xlsx('F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/Source Data.xlsx',sheet = "meta_of_meta-analytica_data")
...
write.xlsx(df_means, file="F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/meta of meta-analytical results.xlsx", sheetName = "Weighted mean results", colNames = TRUE, rowNames = TRUE, append = FALSE)
