...
# --- ROM Method -----
d1 <- readxl::read_xlsx('F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/Source Data.xlsx',sheet ="Figure3a")
d1 <- as.data.table(d1)
...
# ---  MD Method ----
d2 <- readxl::read_xlsx('F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/Source Data.xlsx',sheet ="Figure3b")
d2 <- as.data.table(d2)
...
# --- SMD Method -----
d3 <- readxl::read_xlsx('F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/Source Data.xlsx',sheet ="Figure3c")
d3 <- as.data.table(d3)
...
ggsave(file = "F:/研究生/研究生课程/数据驱动与可重复性研究/小组作业/picture/Figure_3.png", width = 180, height = 210, units = "mm")
